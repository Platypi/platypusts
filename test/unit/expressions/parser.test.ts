...
namespace tests.expressions.parser {
    const parser = plat.acquire(plat.expressions.Parser);
    const context = {
        title: 'Parser',
        fooFn: (arg0: any, arg1: any) => {
            return arg0 + arg1;
        },
        wild: (array0: any, array1: any) => {
        ...
        barz: {
            ...
            customers: {
                ...
                isDumb: true,
                value2: 'value2',
                value3: (input: string, input2: string, input3: string) => {
    ...
    const parserTests: IParserTest[] = [
        ...
        },
        {
            ...
            expression:
                'barz["customers"]["value3"]("Quick and ", "tasty ", fudge())',
            fn: 'toBe',
        },
        {
        ...
        },
        {
            ...
            expression:
                '(math()) > 0 ? 3 > 13 ? fudge() : { test: test } : arrayTest',
            fn: 'toEqual',
        },
        {
        ...
        },
        {
            ...
            expression:
                '(((math() + 20) !== 25) ? customers() + " sucks" : customers() + " is not " + arrayTest[0])',
            fn: 'toBe',
        },
        {
        ...
        },
        {
            ...
            expression:
                '[customers, barz.customers.value3][1]("A crazy ", customers(), " test")',
            fn: 'toBe',
        },
        {
        ...
        },
        {
            ...
            expression:
                '1 + 2 > 4 ? test : test == "hello" ? [customers(), barz.customers.value3(1, 2, 3)] : 0',
            fn: 'toEqual',
        },
        {
        ...
        {
            name:
                'a resource object in array literal in object literal in another object Literal',
        ...
        {
            name:
                'a resource object in object literal in array literal in object Literal',
        ...
        {
            name:
                'a resource object in function call in resource thats in object literal in array literal in object Literal',
        ...
        },
        {
            ...
            expression:
                'thisThis().otherThis()()().thirdThis()().thisThat()()()().test',
            fn: 'toEqual',
        },
        {
            name: 'logical or',
        ...
        parserTests.forEach((test) => {
            it(`should test ${test.name}`, () => {
                ...
                if (test.hasOwnProperty('watch')) {
                    spy = spyOn(context, <any>test.watch);
                ...
                const parsed = parser.parse(test.expression);
                const evaluate = parsed.evaluate(context, {
                    five: 'high ',
                    context: context,
