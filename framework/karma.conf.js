function cfg(config) {
    config.set({
        ...
        files: [
            ...
            './framework/processing/nodemanager/attributemanager.js',
            './framework/routing/history/history.js',
            './framework/routing/navigator/navigator.js',
            ...
            './framework/ui/bindcontrol/bindcontrol.js',
