module plat.ui {
    ...
    export class ViewControl extends TemplateControl implements ISupportNavigation {
         ...
         */
        public hasOwnContext: boolean = true;
         ...
         */
        public static getInstance(): ViewControl {
         ...
         * return a boolean or {@link plat.async.Promise|Promise<boolean>} to accept/reject navigation.
         ...
         * You can return a boolean or {@link plat.async.Promise|Promise<boolean>} to accept/reject navigation.
         * A word of caution, this is a navigation-blocking function. It is best to avoid long-running functions.
         *
         * @returns {any} Either a boolean or Promise<boolean> to accept/reject navigation.
         */
